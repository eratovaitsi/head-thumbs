...
# ─────────────────────────────────────────────────────────────
# XML parsing (UPDATED WITH y_mid)
# ─────────────────────────────────────────────────────────────
...
# ─────────────────────────────────────────────────────────────
# Y MATCHING FUNCTION (NEW)
# ─────────────────────────────────────────────────────────────

def match_age_by_y(person, ages, used):
    py = person["y_mid"]
...
# ─────────────────────────────────────────────────────────────
# PARSING (UPDATED AGE ASSIGNMENT ONLY)
# ─────────────────────────────────────────────────────────────
...
def parse_rows(rows, img_file):
    ...
    people_rows, ages = extract_people_and_ages(rows)
    used_ages = set()  # ✅ new
    ...
    for row in people_rows:
        ...
        age = match_age_by_y(row, ages, used_ages)  # ✅ replaced
